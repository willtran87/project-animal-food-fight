(() => {
  ...
  const ITEMS = [
    ...
    },
    {
      ...
      economyPulseAttackBoostPct: 0.05,
      economyPulseInterval: 7,
      economyPulseDuration: 2.4,
      abilityText: "+1 copy, combat pulse",
      cardText: "Copy pulse",
      description: "A chunky cookie crumb that counts as one extra merge copy while attached to a benched animal and gives small combat pulses.",
    },
    {
      id: "seaweed_wrap",
      kind: "item",
    ...
    },
    {
      ...
      deathSaveRechargeAt: 15,
      abilityText: "Fatal save recharges",
      cardText: "Save recharge",
      description: "A sweet cube that lets the holder survive a fatal hit with a protective shield, then recharges once in long fights.",
    },
    {
      id: "mint_leaf",
      kind: "item",
      ...
      firstDebuffCleanseRechargeAt: 14,
      abilityText: "Cleanse recharges",
      cardText: "Cleanse+",
      description: "A fresh mint leaf that clears the first negative status and heals the holder, then recharges once in long fights.",
    },
    {
      id: "soda_pop",
      kind: "item",
    ...
    },
    {
      ...
      shopWeight: 6,
      decoyHpPct: 0.22,
      decoyRebuildInterval: 13,
      abilityText: "Rebuilds decoy",
      cardText: "Decoy loop",
      description: "A glossy candied cherry that starts battle with a small decoy and rebuilds it if a long fight drags on.",
    },
    {
      id: "breadstick_dummy",
      kind: "item",
      ...
      firstHitRedirectRechargeAt: 12,
      abilityText: "Redirect recharges",
      cardText: "Guard loop",
      description: "Crossed breadsticks that redirect a direct hit, then reset once if the battle lasts long enough.",
    },
    {
      id: "popcorn_kernel",
      kind: "item",
    ...
    },
    {
      ...
      shopWeight: 9,
      sellBonusGold: 18,
      economyPulseAttackBoostPct: 0.04,
      economyPulseInterval: 8,
      economyPulseDuration: 2.2,
      abilityText: "Sell value, combat pulse",
      cardText: "Sell pulse",
      description: "A folded fortune cookie that increases the holder's sell value and gives small combat pulses in long fights.",
    },
    {
      id: "lucky_grape",
      kind: "item",
      ...
      shopWeight: 9,
      surviveGold: 12,
      economyPulseShieldPct: 0.025,
      economyPulseInterval: 7,
      abilityText: "Survive gold, shields",
      cardText: "Gold shield",
      description: "A lucky grape that pays bonus gold when the holder survives battle and pulses small shields during longer fights.",
    },
    {
      id: "shopping_bag",
      kind: "item",
      ...
      economyPulseShieldPct: 0.02,
      economyPulseAttackBoostPct: 0.025,
      economyPulseInterval: 8,
      economyPulseDuration: 2,
      abilityText: "Discount and combat pulse",
      cardText: "Sale pulse",
      description: "A crisp golden wrapper that discounts the first topping bought each round and adds a small long-fight combat pulse.",
    },
    {
      id: "recipe_card",
      kind: "item",
      ...
      economyPulseAttackBoostPct: 0.045,
      economyPulseInterval: 7,
      economyPulseDuration: 2.4,
      abilityText: "Line odds, combat pulse",
      cardText: "Odds pulse",
      description: "A stamped recipe cracker that nudges future shops toward owned lines and grants small combat pulses in long fights.",
    },
    {
      id: "soup_ladle",
      kind: "item",
