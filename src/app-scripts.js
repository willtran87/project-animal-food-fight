(() => {
  ...
  const SCRIPT_GROUPS = Object.freeze({
    ...
    game: [
      ...
      ["presentation-data", "presentation-data-1"],
      ...
      [
        "game",
        "transition-pass-1-pre-final-1-horror-tabs-lower-1-final-reboot-static-1-reveal-meter-language-1-level10-cutscene-plates-1-postgame-horror-lock-1-1600x1000-screens-1-infinite-mode-1-shared-story-canvas-1-random-enemy-formations-1-deploy-result-art-1-pattern-terms-1",
      ],
    ],
  });
