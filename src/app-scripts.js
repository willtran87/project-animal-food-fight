(() => {
  ...
  const SCRIPT_GROUPS = Object.freeze({
    startMenu: [
      ...
      ["start-menu", "h-ab88ec4eec5d"],
    ],
    openingVn: [
      ["dynamic-asset-manifest", "h-8837ceecdfb0"],
      ["audio-settings", "h-16bacfebf841"],
      ["audio-runtime", "h-045ad146f5bc"],
      ["opening-vn", "h-928a76e5b9d6"],
    ],
    game: [
      ["dynamic-asset-manifest", "h-8837ceecdfb0"],
      ...
      ["combat-ledger-capture", "h-84abb0abfbeb"],
      ...
      ["presentation-data", "h-2ebc8485fb69"],
      ["copy-data", "h-f55385845e87"],
      ["story-data", "h-6c4fb236be83"],
      ["trait-arena-data", "h-2e5155bd22b2"],
      ["unit-data", "h-ec1ba92fbeca"],
