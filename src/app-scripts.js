(() => {
  ...
  const SCRIPT_GROUPS = Object.freeze({
    ...
    game: [
      ...
      ["catalog-runtime", "h-769676f6ef40"],
      ["shop-transaction-runtime", "h-a0898420c24c"],
      ["enemy-team-runtime", "h-3b12d8736929"],
