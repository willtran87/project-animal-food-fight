...
The active defeat still is now `runtime/defeat-stills/sushi-seal-war-machine-defeat-v4.png`, a combat-restyle wreck that keeps the SS-07 Tide Recon Drone as the machine husk while exposing rice, salmon, nori, roe, coolant, and wiring from the breached pilot cradle. Its source trail is `source/sushi-seal-war-machine-defeat-v4-chromakey.png` -> `transparent/sushi-seal-war-machine-defeat-v4-transparent.png` -> runtime `192x192`.
...
The active defeat still is now `runtime/defeat-stills/taco-tiger-war-machine-defeat-v5.png`, a combat-restyle wreck that keeps the TT-09 Shellbreaker Assault Rig as the machine husk while exposing tortilla, spiced filling, cheese, salsa, lettuce coolant, and wiring from the breached pilot cradle. Its source trail is `source/taco-tiger-war-machine-defeat-v5-chromakey.png` -> `transparent/taco-tiger-war-machine-defeat-v5-transparent.png` -> runtime `192x192`.
...
The active defeat still is now `runtime/defeat-stills/berry-bat-war-machine-defeat-v3.png`, a combat-restyle wreck that keeps the BB-15 Nightwing Swarm Drone as the machine husk while exposing blackberry/blueberry pulp, syrup, seeds, purple coolant, and wiring from the breached pilot core. Its source trail is `source/berry-bat-war-machine-defeat-v3-chromakey.png` -> `transparent/berry-bat-war-machine-defeat-v3-transparent.png` -> runtime `192x192`.
